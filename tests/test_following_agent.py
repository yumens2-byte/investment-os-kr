...
def test_following_versions():
    ...
    assert run_following.VERSION == "1.2.0"   # 시간별 무작위 후보 상한
    assert config.VERSION == "1.1.0"   # 1~5 무작위 후보 상한
    assert a.VERSION == "1.2.0"        # 자연스러운 검수용 reply 문안
